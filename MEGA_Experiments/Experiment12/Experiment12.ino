...
int ledPin   = 2;  // LED indicator pin
...
{
  // Turn on LED when a code is being processed
  ...
  delay(1000); // short debounce
  digitalWrite(ledPin, LOW); // turn LED OFF after processing
} // END translateIR
